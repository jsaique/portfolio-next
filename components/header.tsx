...
//           <nav
//             className={classNames(
//               "h-[calc(100vh_-_var(--navigation-height))] md:block fixed top-navigation-height left-0 w-full overflow-auto bg-background transition-opacity duration-500 md:relative md:top-0 md:h-auto md:w-auto md:bg-transparent md:opacity-100",
...
//                 "[&_a]:flex [&_a]:items-center [&_a]:h-navigation-height [&_a]:w-full [&_a]:translate-y-8 [&_a]:text-md [&_a:hover]:text-grey [&_a]:transition-[color, transform] md:[&_a]:text-sm md:[&_a]:translate-y-1 [&_a]:duration-500",
